export const PONIES_ABI = [
  ...
  {
    inputs: [
      { internalType: 'address', name: 'newCodeSigner', type: 'address' },
    ],
    name: 'setCodeSigner',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_newMintStartBlock', type: 'uint256' },
    ],
    name: 'setMintStartBlock',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
